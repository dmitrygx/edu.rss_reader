...
public class MusicActivity extends AppCompatActivity implements RetrieveFeedTask.AsyncResponse {

    private final String RSS_MUSIC = "http://news.yandex.ru/music.rss";
    private final String FILE_MUSIC = "Lab5Music.xml";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feedParser = new DomFeedParser(RSS_MUSIC, FILE_MUSIC);
