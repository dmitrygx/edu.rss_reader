...
public class SportActivity extends AppCompatActivity implements RetrieveFeedTask.AsyncResponse {

    private final String RSS_SPORT = "http://news.yandex.ru/sport.rss";
    private final String FILE_SPORT = "Lab5Sport.xml";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feedParser = new DomFeedParser(RSS_SPORT, FILE_SPORT);
