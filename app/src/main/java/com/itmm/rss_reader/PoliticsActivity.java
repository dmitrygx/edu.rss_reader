...
public class PoliticsActivity extends AppCompatActivity implements RetrieveFeedTask.AsyncResponse {

    private final String RSS_POLIT = "http://news.yandex.ru/politics.rss";
    private final String FILE_POLIT = "Lab5Polit.xml";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feedParser = new DomFeedParser(RSS_POLIT, FILE_POLIT);
