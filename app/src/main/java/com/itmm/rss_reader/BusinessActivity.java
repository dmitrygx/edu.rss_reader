...
public class BusinessActivity extends AppCompatActivity implements RetrieveFeedTask.AsyncResponse {

    private final String RSS_ECNMK = "http://news.yandex.ru/business.rss";
    private final String FILE_ECNMK = "Lab5Econom.xml";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feedParser = new DomFeedParser(RSS_ECNMK, FILE_ECNMK);
